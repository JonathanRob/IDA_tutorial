...
```{r readDE}
diffExpRes <- read.delim('DE_results_glucose.txt', stringsAsFactors=F)
head(diffExpRes)  # check that our dataframe looks as expected
```
