...
networkPlot2(gsaRes, "distinct", "both", adjusted=T, significance=0.001, ncharLabel=Inf,
             nodeSize=c(5,25), edgeWidth=c(2,10), labelSize=20, overlap=10, physics=F,
             scoreColors=c("red", "orange", "yellow", "blue", "lightblue", "lightgreen"))
```
...
```{r, message=F, warning=F, results='hide', echo=T, fig.height=16}
GSAheatmap(gsaRes, adjusted=T, ncharLabel=Inf, cellnote='rank')
```
...
```{r}
gscGO <- loadGSC('data/GSC_yeast/yeastGEM.xml')
gscGO  # take a look
```
